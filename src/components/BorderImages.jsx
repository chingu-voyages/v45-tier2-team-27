...
export default function BorderImages(){
    ...
    return(
        <>
            ...
            <div>
                <img className="desktop-right-line" src={`${darkMode ? "/images/white-desktop-right-line.png" : "/images/desktop-right-line.png"}`} alt="" />
                <img className="desktop-left-line" src={`${darkMode ? "/images/white-desktop-left-line.png" : "/images/desktop-left-line.png"}`} alt="" />
            </div>
        </>
    )
}